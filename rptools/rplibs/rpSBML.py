...
class rpSBML:
    ...
    @staticmethod
    def score_for_reactions(rpsbml_dict, scores, bounds, pathway_id, logger=logging.getLogger(__name__)):
    ...
    @staticmethod
    def score_from_pathway(rpsbml_dict, scores, bounds, pathway_id, logger=logging.getLogger(__name__)):
