...
class Test_rpFBA(TestCase):
    ...
    def test_fba(self):
        ...
        self.assertAlmostEqual(all_json['pathway']['brsynth']['fba_obj_Rxn_sink']['value'], 9.230769230769237)
    ...
    def test_fraction(self):
        ...
        # make sure that the results are written to the file
        all_json = rpsbml.genJSON()
        self.assertAlmostEqual(all_json['pathway']['brsynth']['fba_obj_Rxn_sink__restricted_biomass']['value'], 2.3076923076923888)
    ...
    def test_pfba(self):
        ...
        # make sure that the results are written to the file
        all_json = rpsbml.genJSON()
        self.assertAlmostEqual(all_json['pathway']['brsynth']['fba_obj_Rxn_sink']['value'], 859.3846153846168)
